...
class Sliderwidget2ItemWidget extends StatelessWidget {
  Sliderwidget2ItemWidget(
    this.sliderwidget2ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Sliderwidget2ItemModel sliderwidget2ItemModelObj;
