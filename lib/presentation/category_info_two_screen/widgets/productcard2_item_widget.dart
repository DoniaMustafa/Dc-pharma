      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Text(
                    productcard2ItemModelObj.discountText!,
                    style: theme.textTheme.labelMedium,
                  ),
                ),
                CustomImageView(
                  imagePath: productcard2ItemModelObj?.favoriteIcon,
                  height: 20.adaptSize,
                  width: 20.adaptSize,
          ...
          Padding(
            padding: EdgeInsets.only(left: 2.h),
            child: Text(
              productcard2ItemModelObj.companyName!,
          ...
          Padding(
            ...
            child: Row(
              children: [
                CustomImageView(
                  imagePath: productcard2ItemModelObj?.ratingIcon,
                  height: 12.adaptSize,
                  width: 12.adaptSize,
                ),
                Padding(
                  ...
                  child: Text(
                    productcard2ItemModelObj.ratingText!,
                ...
                Padding(
                  ...
                  child: Text(
                    productcard2ItemModelObj.reviewText!,
                    style: theme.textTheme.bodySmall,
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text(
                  productcard2ItemModelObj.priceText1!,
                ...
                Padding(
                  ...
                  child: Text(
                    productcard2ItemModelObj.priceText2!,
