...
class Sliderwidget1ItemWidget extends StatelessWidget {
  Sliderwidget1ItemWidget(
    this.sliderwidget1ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Sliderwidget1ItemModel sliderwidget1ItemModelObj;
