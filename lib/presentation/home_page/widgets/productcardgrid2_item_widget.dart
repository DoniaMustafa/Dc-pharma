        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      productcardgrid2ItemModelObj.widget!,
            ...
            Padding(
              padding: EdgeInsets.only(left: 2.h),
              child: Text(
                productcardgrid2ItemModelObj.productName!,
            ...
            Padding(
              padding: EdgeInsets.only(left: 2.h),
              child: Text(
                productcardgrid2ItemModelObj.productDescription!,
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      productcardgrid2ItemModelObj.ratingValue!,
                  ...
                  Padding(
                    ...
                    child: Text(
                      productcardgrid2ItemModelObj.reviewCount!,
                      style: theme.textTheme.bodySmall,
                    ),
                  ),
                ],
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          productcardgrid2ItemModelObj.originalPrice!,
                        ...
                        SizedBox(height: 2.v),
                        Text(
                          productcardgrid2ItemModelObj.discountedPrice!,
                  ...
                  Padding(
                    ...
                    child: CustomIconButton(
                      ...
                      child: CustomImageView(
                        imagePath:
                            productcardgrid2ItemModelObj?.addToCartButton,
                      ),
                    ),
                  ),
                ],
