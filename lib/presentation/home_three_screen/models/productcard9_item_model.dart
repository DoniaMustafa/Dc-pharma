...
class Productcard9ItemModel {Productcard9ItemModel({this.discountText, this.productName, this.productCompany, this.ratingText, this.reviewText, this.originalPrice, this.discountedPrice, this.addToCartButton, this.id, }) { discountText = discountText  ?? "-15%";productName = productName  ?? "panadol advace";productCompany = productCompany  ?? "from : gsk company";ratingText = ratingText  ?? "4.5";reviewText = reviewText  ?? "(1045 Reviews)";originalPrice = originalPrice  ?? "335,00";discountedPrice = discountedPrice  ?? "235,00";addToCartButton = addToCartButton  ?? ImageConstant.imgCart;id = id  ?? ""; }
